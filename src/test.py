...
from .data.common import NORMALIZE_PARAMS, collate_fn
from .data.coco import CocoDataset
from .transforms import MakeMap
...
def validate(model, data_loader, device, criterions, score_threshold):
    print("  Validation")
    model.eval()
    meters = {k + "_loss": MeanMeter() for k in criterions.keys()}
    meters["loss"] = MeanMeter()
